/** Canonical DP CLUB logo (PNG) — use everywhere brand mark appears in UI. */
export const brandLogoUrl = '/assets/logo/dp-club-logo.png';

export const brandName = 'DP CLUB';
export const brandFullName = 'Duo Poker Club';
