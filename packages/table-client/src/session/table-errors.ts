...
const ERROR_KEY_MAP: Record<string, string> = {
  ...
  ILLEGAL_CHECK: 'table.errors.illegalCheck',
  ILLEGAL_CALL: 'table.errors.illegalCall',
  NO_ACTIVE_HAND: 'table.errors.noActiveHand',
  HAND_OVER: 'table.errors.handOver',
  ALL_IN: 'table.errors.allIn',
  UNKNOWN_ACTION: 'table.errors.unknownAction',
